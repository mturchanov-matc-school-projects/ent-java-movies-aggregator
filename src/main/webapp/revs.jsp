    ...
    <div class="container" id="content">
        ...
        <form action="${pageContext.request.contextPath}/searchMovie" method="get" class="">
            <div class="row">
                ...
                <div class="card-header col-md-4 " id="mainFunc">
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-md-8 extraInformation active" id="reviewSources">
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <div class="list-group d-flex justify-content-evenly flex-row flex-wrap " id="revContent">
