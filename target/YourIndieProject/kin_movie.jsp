...
<div class="container-fluid bg-white" id="wrapper">
    ...
    <div id="movieInfo" class="row mb-3">
        <div class="col-lg-4 col-sm-12 text-center" id="movieImage">
            <img src="${movie.kinopoiskImage}" alt="image ${movie.rusName}">
        </div>
        ...
        <div class="col-lg-8 col-sm-12">
            <div class="row" id="movieTitleDescInfo">
                <div class="card">
                    ...
                    <div class="card-body">
                        <c:if test="${movie.rusName != null} ">
                            <h5 class="card-title">${movie.rusName} <small>(${movie.engName})</small></h5>
                        </c:if>

                        <p class="card-text">
                            ${movie.kinopoiskDescription}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row" id="movieTableInfo">
                ...
                <div class="col-lg-7 col-sm-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <c:if test="${movie.kinopoiskGenre != null}">
                            <tr>
                                <td>Genre(s)</td>
                                <td>${movie.kinopoiskGenre}</td>
                            </tr>
                        </c:if>
                        ...
                        <c:if test="${movie.kinopoiskCountry != null}">
                            <tr>
                                <td>Country</td>
                                <td>${movie.kinopoiskCountry}</td>
                            </tr>
                        </c:if>
